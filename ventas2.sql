...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2016 a las 20:45:55
...
INSERT INTO `cxp` (`idcxp`, `idmovto`, `idproveedores`, `monto`, `iva`, `total`, `fechamov`, `usu`) VALUES
...
INSERT INTO `inventario` (`idinventario`, `idproductos`, `tipomov`, `cant`, `fechamov`, `usu`, `comentarios`, `idoc`, `monto`) VALUES
...
INSERT INTO `ivaacred` (`idivaacred`, `idmovto`, `monto`, `fechamov`, `usu`, `status`) VALUES
...
(8, 'QO500', '11111', 'QUESO OAXACA 1/2 KG', 'OAXACA 1/2K', 1, 2, '500.00', 'QUESO OAXACA DE 500 GRAMOS', '46.50', '54.00', '58.00', '63.00', 1, 'j.maldonado', '2016-06-13 04:45:37', 0),
...
(24, 'IG024', '00024', 'SALMON AHUMADO REBANADO 100 GR', 'SALMON AHUM 100G', 2, 2, '100.00', 'SALMON AHUMADO CONGELADO EMPAQUE AL VACIO PORTION CONTROL 100 GRAMOS MARCA NORDKINN ', '58.63', '76.00', '80.00', '82.00', 2, 'j.maldonado', '2016-08-10 04:08:23', 0);
...
--
ALTER TABLE `artsoc`
  MODIFY `idartsoc` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `oc`
  MODIFY `idoc` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `productos`
  MODIFY `idproductos` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
